...
import kr.co.kimberly.wma.databinding.CellSearchDevicesListBinding
...
class SearchDevicesAdapter(context: Context, activity: Activity): RecyclerView.Adapter<SearchDevicesAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding: CellSearchDevicesListBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(
        ...
        val binding = CellSearchDevicesListBinding.inflate(LayoutInflater.from(parent.context), parent, false)
